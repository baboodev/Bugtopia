...
namespace HeartopiaMod
{
    public partial class HeartopiaComplete
    {
        ...
        private void ProcessPendingAutoSellListRescan()
        {
            ...
            // Phase 5: "user is looking at the Auto Sell tab" is the UGUI shell's sub-tab now
            // (the IMGUI menu/tab gate is retired). Same cancel-when-hidden behavior.
            if (!this.IsUguiShellFeaturesSubTabActive(UguiShellFeaturesAutoSellSubIndex))
            {
