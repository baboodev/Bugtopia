...
namespace HeartopiaMod
{
    internal static class LocalizationManager
    {
        ...
        private static readonly Dictionary<string, string> EnglishDefaults = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "UNPIN FROM MAP", "UNPIN FROM MAP" },
            { "Figurine pinned on the game map.", "Figurine pinned on the game map." },
            { "Figurine unpinned from the map.", "Figurine unpinned from the map." },
        ...
        private static readonly Dictionary<string, string> SpanishDefaults = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "UNPIN FROM MAP", "QUITAR DEL MAPA" },
            { "Figurine pinned on the game map.", "Figurita marcada en el mapa." },
            { "Figurine unpinned from the map.", "Figurita quitada del mapa." },
        ...
        private static readonly Dictionary<string, string> ChineseSimplifiedDefaults = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "SHOW ON MAP", "在地图上显示" },
            { "UNPIN FROM MAP", "从地图移除" },
            { "Figurine pinned on the game map.", "摆件已标记在地图上。" },
            { "Figurine unpinned from the map.", "已从地图移除摆件标记。" },
        ...
        private static readonly Dictionary<string, string> PortugueseDefaults = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "UNPIN FROM MAP", "REMOVER DO MAPA" },
            { "Figurine pinned on the game map.", "Estatueta marcada no mapa." },
            { "Figurine unpinned from the map.", "Estatueta removida do mapa." },
        ...
        private static readonly Dictionary<string, string> ThaiDefaults = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "UNPIN FROM MAP", "เอาออกจากแผนที่" },
            { "Figurine pinned on the game map.", "ปักหมุดฟิกเกอร์บนแผนที่แล้ว" },
            { "Figurine unpinned from the map.", "เอาหมุดฟิกเกอร์ออกจากแผนที่แล้ว" },
